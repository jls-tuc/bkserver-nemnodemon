...
const getForm = async(req, res = response) => {
    ...
    console.log(" start: ", req.body.fechaDesde);
    console.log(" end: ", req.body.fechaHasta);

    console.log(" start: ", desde);
    console.log(" end: ", hasta);
    if (req.body.fechaDesde && req.body.fechaHasta) {
        desde = moment(new Date(req.body.fechaDesde)).utc().startOf("day").toDate();
        hasta = moment(new Date(req.query.fechaHasta)).utc().endOf("day").toDate();
    }
    console.log("Fe3chasss start: ", desde);
    console.log("Fe3chasss end: ", hasta);
    ...
    if (req.body["localidad"]) {
        ...
        console.log(" localidad: ", req.body.localidad);
    }
